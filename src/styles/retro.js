...
export const retroShader = {
  name: 'retro',
  uniforms: {
    pixelation: { default: 5.0, min: 1, max: 10, label: 'Pixellisation' },
    distortion: { default: 0, min: 0, max: 1, label: 'Distorsion' },
    instability: { default: 0.4, min: 0, max: 1, label: 'Instabilité' },
  },
  fragmentShader: /* glsl */ `
